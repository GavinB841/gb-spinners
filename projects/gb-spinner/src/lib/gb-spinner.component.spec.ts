...
describe('GbSpinner', () => {
  ...
  // Test the component
  describe('GbSpinnerComponent', () => {
    let component: GbSpinnerComponent;
    const mocks: any = {};

    beforeEach(() => {
      mocks.spinner = jasmine.createSpyObj('GbSpinnerService', ['registerComponent']);
      component = new GbSpinnerComponent(mocks.spinner);
    });
  ...
  describe('GbSpinnerService', () => {
    ...
    const mocks: any = {};
    beforeEach(() => {
      mocks.spinnerComponent = jasmine.createSpyObj('GbSpinnerComponent', ['show', 'hide']);
      service = new GbSpinnerService();
    });
    describe('show', () => {

import { GbCircleSpinnerComponent } from './gb-circle-spinner.component';
...
describe('GbSpinner', () => {
  ...
  // Test the component
  describe('GbCircleSpinnerComponent', () => {
    let component: GbCircleSpinnerComponent;
    const mocks: any = {};

    beforeEach(() => {
      mocks.spinner = jasmine.createSpyObj('GbCircleSpinnerService', ['registerComponent']);
      component = new GbCircleSpinnerComponent(mocks.spinner);
    });
  ...
  describe('GbCircleSpinnerService', () => {
    ...
    const mocks: any = {};
    beforeEach(() => {
      mocks.spinnerComponent = jasmine.createSpyObj('GbCircleSpinnerComponent', ['show', 'hide']);
      service = new GbCircleSpinnerService();
    });
    describe('show', () => {
